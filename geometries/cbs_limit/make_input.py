...
parser.add_argument('-mf', '--multipole_field', nargs='+', help='specify multipole field in direction, given by "d1 d2"')
...
$end
    ...
    '''.format(args.method, args.basis, i, args.strength[c])
